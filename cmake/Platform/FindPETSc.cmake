...
")
    ...
    if (${${runs}})
      set (PETSC_EXECUTABLE_RUNS "YES" CACHE BOOL
        "Can the system successfully run a PETSc executable?  This variable can be manually set to \"YES\" to force CMake to accept a given PETSc configuration, but this will almost always result in a broken build.  If you change 
PETSC_DIR, PETSC_ARCH, or PETSC_CURRENT you would have to reset this variable." FORCE)
    endif (${${runs}})
...
if( (NOT DEFINED ENV{PETSC_LIBRARIES}) OR (NOT DEFINED ENV{PETSC_INCLUDES}) ) 
	include (FindPackageHandleStandardArgs)
	find_package_handle_standard_args (PETSc
  	 "DMS could not find PETSc. Be sure to set PETSC_LIBRARIES and PETSC_INCLUDES."
  	 PETSC_INCLUDES PETSC_LIBRARIES PETSC_EXECUTABLE_RUNS) 
endif() 

set(PETSC_INCLUDES $ENV{PETSC_INCLUDES} CACHE STRING "PETSc include path" FORCE)
set(PETSC_LIBRARIES $ENV{PETSC_LIBRARIES} CACHE STRING "PETSc library path" FORCE)

message(STATUS "Using user-specified petsc-lib ${PETSC_LIBRARIES} and include dir ${PETSC_INCLUDES}")
