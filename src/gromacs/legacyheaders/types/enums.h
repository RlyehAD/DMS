...
enum {
    eiMD, eiSteep, eiCG, eiBD, eiSD2, eiNM, eiLBFGS, eiTPI, eiTPIC, eiSD1, eiVV, eiVVAK, eiDMS, eiNR
};
//  Andrew: added eiDMS as a new multiscale integrator


#define EI_VV(e) ((e) == eiVV || (e) == eiVVAK)
// Andrew: modified EI_MD(e)
#define EI_MD(e) ( ((e) == eiMD || (e) == eiDMS) || EI_VV(e))
