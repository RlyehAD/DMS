...
enum
{
    etINT, etINT64, etREAL, etTIME, etSTR, etBOOL, etRVEC, etENUM, etRVECI, etNR 
    // Andrew: I added etRVECI (indeterminate) which is a large array (on the stack) 
    // that must be used to parse args pertaining to the electric field with multiple
    // frequencies 
};
