...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSw_VdwLJSw_GeomW4W4_VF_avx_128_fma_single
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
	    ...
	    rsq13            = _mm_add_ps(rsq13, dms_dist_sq);
	    ...
	    rsq23            = _mm_add_ps(rsq23, dms_dist_sq);

            rsq31            = gmx_mm_calc_rsq_ps(dx31,dy31,dz31);
	    rsq31            = _mm_add_ps(rsq31, dms_dist_sq);

            rsq32            = gmx_mm_calc_rsq_ps(dx32,dy32,dz32);
	    rsq32            = _mm_add_ps(rsq32, dms_dist_sq);

            rsq33            = gmx_mm_calc_rsq_ps(dx33,dy33,dz33);
	    rsq33            = _mm_add_ps(rsq33, dms_dist_sq);
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W4W4_VF,outeriter*26 + inneriter*552);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecEwSw_VdwLJSw_GeomW4W4_F_avx_128_fma_single
 * Electrostatics interaction: Ewald
 * VdW interaction:            LennardJones
 * Geometry:                   Water4-Water4
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_VDW_W4W4_F,outeriter*24 + inneriter*522);
}
