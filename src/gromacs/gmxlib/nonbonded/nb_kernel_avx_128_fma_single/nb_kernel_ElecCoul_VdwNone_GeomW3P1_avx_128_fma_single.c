...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCoul_VdwNone_GeomW3P1_VF_avx_128_fma_single
                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    inc_nrnb(nrnb,eNR_NBKERNEL_ELEC_W3_VF,outeriter*19 + inneriter*93);
}
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCoul_VdwNone_GeomW3P1_F_avx_128_fma_single
 * Electrostatics interaction: Coulomb
 * VdW interaction:            None
 * Geometry:                   Water3-Particle
