...
void checkForceBound(rvec f[], t_mdatoms *mdatoms) {
    // Hacked here by Andrew Sun Aug 31, 2014
    // to make sure forces are bounded and dont go flying

    int i, dim;
    real force_threshold = 3000.0;
