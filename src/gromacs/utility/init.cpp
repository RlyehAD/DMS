...
#else
        (void) PetscInitialize(argc, argv, NULL, NULL); // I had to add PetscInitialize here , which will call MPI_Init(argc, argv) 
	// This is important when the user chooses PME which uses a fraction of the processors to compute the long range forces
#endif
    }
