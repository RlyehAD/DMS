...
#ifndef DMS_INTEGRATOR_H
#define DMS_INTEGRATOR_H
...
public:
	DmsIntegrator() {};
	DmsIntegrator(PetscScalar, bool, MPI_Comm);
	MPI_Comm getComm() const { return comm; }

	virtual PetscErrorCode integrate(const CVec&, const CVec&) { std::cerr << "Not yet implemented ..." << std::endl; };
	virtual ~DmsIntegrator() {};
