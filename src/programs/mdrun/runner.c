...
// Andrew: added do_dms as a new multiscale integrator
const gmx_intp_t    integrator[eiNR] = { {do_md}, {do_steep}, {do_cg}, {do_md}, {do_md}, {do_nm}, {do_lbfgs}, {do_tpi}, {do_tpi}, {do_md}, {do_md}, {do_md}, {do_dms}};
...
/* The function used for spawning threads. Extracts the mdrunner()
   ...
   a commrec. */
static void mdrunner_start_fn(void *arg, const int petsc_argc, char* petsc_argv[])
{
    ...
    mdrunner(&mc.hw_opt, fplog, cr, mc.nfile, fnm, mc.oenv,
             ...
             mc.cpt_period, mc.max_hours, mc.deviceOptions, mc.imdport, mc.Flags, petsc_argc, petsc_argv);
}
